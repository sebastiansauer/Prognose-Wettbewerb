...
#' @param verbose are the submission files names provided with full (absolute) path? (lgl, defaults to FALSE)
#'
#' @return sanitized data frame of individual submission (two cols: id, pred). See details.
#' @export
#'
#' @examples
...
join_pred_solution <- function(submission_file,
  ...
  # assumiing that submissions file is without path:
